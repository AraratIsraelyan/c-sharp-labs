...
namespace Lab5
{
    class String
    {
        public static void SumInWorld(int a)
        {
        ...
        public static void TestStringBuilder()
        {
            ...
            StringBuilder  str2 = new StringBuilder("Интересно, а Яавел Владимирович смотрит скринкасты?");
        ...
        static void Main()
        {
            ...
            //"синтаксис: 's' - экземпляр, '5' - количество строк (экземпляров) типа string"
            Console.WriteLine(str2);
            ...
            else Console.WriteLine("N.O.");
            if (stri1 != str3)
            {
                Console.WriteLine("Y.E.S");
            }
            string stri2 = stri1 + str3;
            Console.WriteLine(stri2);
            Console.WriteLine(stri2[6]);

            string message = "Надо скопировать содержание скобок /*комментария student*/в новую строку /*!*/3";
            string comment = "";
            Console.WriteLine();
            ...
            String.SumInWorld(8008);
            
            string a = "Зима. Кругом лежит белый снег.";
            String.SplitJoin(a);
            ...
            Console.WriteLine();
            StringBuilder  sb1 = new StringBuilder("Хочу сказать этому Обаме");
            StringBuilder  sb2 = new StringBuilder("Был бы ты человеком ");
            Console.WriteLine(sb1);
            Console.WriteLine(sb2);
            Console.WriteLine(sb1.Append(sb2));
            Console.WriteLine(sb2.Insert(0, "Лучше сяоми в руке, чем айфон в магазине. "));
            ...
            Console.WriteLine($"Текущая емкость буфера: [{sb3.Capacity}]");
            //Возвращает максимальную емкость данного экземпляра. Наибольшее количество символов, которое может содержать данный экземпляр.
            Console.WriteLine($"Максимальная емкость буфера: [{sb3.MaxCapacity}]");
            Console.WriteLine($"Новая емкость этого экземпляра: [{sb1.EnsureCapacity(50)}]");
            
            Console.WriteLine();

            char[] ch1 = {'S', 'T', 'A', 'Y', ' ', 'A', 'T', ' ', 'H', 'O', 'M', 'E', '!'} ;
            string str4 = "";
            ...
            char[] ch2 = {'W', 'H', 'Y', ' ', 'A', 'R', 'E', ' ', 'Y', 'O', 'U', ' ', 'G', 'A', 'Y', '?'} ;
